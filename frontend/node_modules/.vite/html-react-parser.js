    ...
    function formatDOM(nodes, parent, directive) {
      ...
      for (var index = 0, len2 = nodes.length; index < len2; index++) {
        ...
        switch (node.nodeType) {
          case 1:
            current = new Element2(formatTagName(node.nodeName), formatAttributes(node.attributes));
...
// dep:html-react-parser
var html_react_parser_default2 = html_react_parser_default;
export {
  Element,
  attributesToProps,
  html_react_parser_default2 as default,
  domToReact,
  htmlToDOM
};
